...
public class OdabirKategorijeAdapter extends RecyclerView.Adapter<OdabirKategorijeAdapter.OdabirKategorijeViewHolder> {
    public static class OdabirKategorijeViewHolder extends RecyclerView.ViewHolder{
        ...
        OdabirKategorijeViewHolder(View itemView) {
            ...
            kategorijaNaziv = (TextView)itemView.findViewById(R.id.kategorija_naziv);
            gumbDalje = (Button) itemView.findViewById(R.id.button_dalje);
            cb = (CheckBox) itemView.findViewById(R.id.odabir_kategorije_checkbox);

            rv = (RecyclerView) itemView.findViewById(R.id.rv_kategorije);
    ...
    public OdabirKategorijeViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.odabir_kategorije_item, parent, false);
    ...
    public void onBindViewHolder(OdabirKategorijeViewHolder holder, int i) {
        ...
        holder.cb.setLabelFor(R.id.kategorija_naziv);
        ...
        checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener(){
            ...
            public void onCheckedChanged(CompoundButton buttonView,boolean isChecked) {
                if(isChecked){
                    ...
                    TextView textView = (TextView) row.findViewById(R.id.kategorija_naziv);
